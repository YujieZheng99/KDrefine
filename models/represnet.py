...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None, is_last=False):
        ...
        self.conv1 = conv_bn(in_channels=in_planes, out_channels=planes, kernel_size=3, stride=stride, padding=1)
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=100):
        ...
        self.conv1 = conv_bn(3, num_filters[0], kernel_size=3, padding=1)
        self.relu = nn.ReLU(inplace=True)
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        x, f1_pre = self.layer1(x)  # 16x32x32
        f1 = x
