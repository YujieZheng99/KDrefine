...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, out_planes, stride, groups, is_last=False):
        ...
        self.conv2 = conv_bn(mid_planes, mid_planes, kernel_size=3, stride=stride, padding=1, groups=mid_planes)
...
if __name__ == '__main__':
    ...
    net = repShuffleV1(num_classes=100)
    import time
    a = time.time()
