...
def parse_option():
    ...
    parser.add_argument('--model_original', type=str, default='vgg16',
    ...
    parser.add_argument('--model_rep', type=str, default='repmobilenetv2',
                        choices=['represnet20', 'represnet32', 'repvgg8', 'repmobilenetv2'])
    parser.add_argument('-t', '--blocktype', metavar='BLK', default='ACTDB', choices=['DBB', 'ACB', 'base'])
